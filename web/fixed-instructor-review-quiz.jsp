...
<!-- Mirrored from learnplus.frontendmatter.com/fixed-instructor-review-quiz.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Jun 2018 08:43:05 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Instructor - Review quiz - Fixed layout</title>
        ...
        <div class="page-heading">
            <div class="media">
                ...
                <div class="media-body media-middle">
                    ...
                    <span class="text-muted">submited by</span> <a href="fixed-instructor-profile.html">Adrian
                        Demian</a>
                </div>
                <div class="media-right">
                    <div style="width:80px" class="text-right">
                        ...
                        <a style="color: #fff; background-color: #ff6600; border-color: #ff6600;" href="#"
                            class="btn btn-primary btn-sm"><i class="material-icons">keyboard_arrow_right</i>
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <p>
                                        ...
                                        blanditiis iste itaque deleniti minima.
                                    </p>
            ...
            <table class="table table-sm table-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-muted">Feb 17th, 2016 by <a href="fixed-instructor-profile.html">Adrian D.</a>
                        </td>
        ...
        <div class="mdk-drawer__content ls-top-navbar-xs-up">
            <div class="sidebar sidebar-left sidebar-light bg-white o-hidden">
                <div class="sidebar-p-y" data-simplebar data-simplebar-force-enabled="true">
                    ...
                    <ul class="sidebar-menu">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="instructor-review-quiz.html">
                                <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dashboard</i> Fluid
                                Layout
                            </a>
                        </li>
                        <li class="sidebar-menu-item active">
                            <a class="sidebar-menu-button" href="fixed-instructor-review-quiz.html">
