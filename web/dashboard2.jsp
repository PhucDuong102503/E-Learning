...
<head>
	...
	<link rel="stylesheet" href="css2/skin.css">
</head>
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="images2/logo-white-2.png" alt="">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="images2/profile/education/pic1.jpg" width="20" alt="">
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
						...
						<div class="card">
                            ...
                            <div class="card-body">
								<div class="media mb-3 align-items-center border-bottom pb-3">
                                    <img class="mr-3 rounded-circle" alt="image" width="50" src="images2/profile/education/pic1.jpg">
                                    <div class="media-body">
								...
								<div class="media mb-3 align-items-center border-bottom pb-3">
                                    <img class="mr-3 rounded-circle" alt="image" width="50" src="images2/profile/education/pic2.jpg">
                                    <div class="media-body">
								...
								<div class="media mb-3 align-items-center border-bottom pb-3">
                                    <img class="mr-3 rounded-circle" alt="image" width="50" src="images2/profile/education/pic3.jpg">
                                    <div class="media-body">
								...
								<div class="media mb-3 align-items-center border-bottom pb-3">
                                    <img class="mr-3 rounded-circle" alt="image" width="50" src="images2/profile/education/pic4.jpg">
                                    <div class="media-body">
								...
								<div class="media mb-2 align-items-center border-bottom pb-3">
                                    <img class="mr-3 rounded-circle" alt="image" width="50" src="images2/profile/education/pic5.jpg">
                                    <div class="media-body">
									...
									<div id="my-posts" class="tab-pane fade active show">
										<div class="table-responsive">
											<table class="table table-responsive-md">
												...
												<tbody>
													<tr>
														<td><img src="images2/profile/education/pic1.jpg" class="rounded-circle" width="35" alt=""></td>
														<td>Angelica Ramos</td>
													...
													<tr>
														<td><img src="images2/profile/education/pic2.jpg" class="rounded-circle" width="35" alt=""></td>
														<td>Bradley Greer</td>
													...
													<tr>
														<td><img src="images2/profile/education/pic3.jpg" class="rounded-circle" width="35" alt=""></td>
														<td>Cedric Kelly</td>
													...
													<tr>
														<td><img src="images2/profile/education/pic4.jpg" class="rounded-circle" width="35" alt=""></td>
														<td>Caesar Vance</td>
														<td><span class="badge badge-rounded badge-danger">Unpaid</span></td>
														<td>09 April 2020</td>
														<td>$300</td>
													...
													<tr>
														<td><img src="images2/profile/education/pic5.jpg" class="rounded-circle" width="35" alt=""></td>
														<td>Rhona Davidson</td>
														<td><span class="badge badge-rounded badge-warning">Pending</span></td>
														<td>08 March 2020</td>
														<td>$500</td>
									...
									<div id="about-me" class="tab-pane fade">
										<div class="table-responsive">
											<table class="table table-responsive-md">
												...
												<tbody>
													<tr>
														<td><img src="images2/profile/education/pic6.jpg" class="rounded-circle" width="35" alt=""></td>
														<td>Angelica Ramos</td>
														<td><span class="badge badge-rounded badge-success">Paid</span></td>
														<td>12 August 2020</td>
														<td>$100</td>
													...
													<tr>
														<td><img src="images2/profile/education/pic7.jpg" class="rounded-circle" width="35" alt=""></td>
														<td>Bradley Greer</td>
														<td><span class="badge badge-rounded badge-danger">Unpaid</span></td>
														<td>11 July 2020</td>
														<td>$200</td>
													...
													<tr>
														<td><img src="images2/profile/education/pic8.jpg" class="rounded-circle" width="35" alt=""></td>
														<td>Cedric Kelly</td>
														<td><span class="badge badge-rounded badge-warning">Pending</span></td>
														<td>10 May 2020</td>
														<td>$400</td>
													...
													<tr>
														<td><img src="images2/profile/education/pic10.jpg" class="rounded-circle" width="35" alt=""></td>
														<td>Caesar Vance</td>
														<td><span class="badge badge-rounded badge-danger">Unpaid</span></td>
														<td>09 April 2020</td>
														<td>$300</td>
													...
													<tr>
														<td><img src="images2/profile/education/pic9.jpg" class="rounded-circle" width="35" alt=""></td>
														<td>Rhona Davidson</td>
														<td><span class="badge badge-rounded badge-warning">Pending</span></td>
														<td>08 March 2020</td>
														<td>$500</td>
    ...
    ***********************************-->
    ...
    <script src="vendor/peity/jquery.peity.min.js"></script>
		...
		<!-- Demo scripts -->
    <script src="js2/dashboard/dashboard-2.js"></script>
